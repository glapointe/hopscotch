    ...
    parseHTMLString: function (htmlString) {
        ...
        for (let i = 0; i < htmlString.length; i++) {
            ...
            if (char === "<") {
                ...
                const tag = htmlString.slice(i + 1, closingBracketIndex);
                ...
                if (isClosingTag) {
                    ...
                    let isValue = false;
                    let isQuote = false;
                    for (let j = 0; j < attributes.trim().length; j++) {
                        const attrChar = attributes[j];
                        if (attrChar === "=") {
                            isName = false;
                            isValue = true;
